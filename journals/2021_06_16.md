  ...
  collapsed:: true
	...
	- enums with the [[enum]] module
		-
		  ...
		  ```
		-
- DONE [[Python]] [[black]] [[flake8]] [https://medium.com/staqu-dev-logs/keeping-python-code-clean-with-pre-commit-hooks-black-flake8-and-isort-cac8b01e0ea1](https://medium.com/staqu-dev-logs/keeping-python-code-clean-with-pre-commit-hooks-black-flake8-and-isort-cac8b01e0ea1)
  done:: 1623879944870
  todo:: 1623879931286
-
-