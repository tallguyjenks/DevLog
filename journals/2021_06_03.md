...
- DONE [[Python]] the `_` in python can hold the last value in an interactive shell session but can be used like the unnamed register in [[VIM]] and you can use it to avoid issues when unpacking tuples or just throwing something away:
  todo:: 1622753128942
	...
	-
	  ...
	  #> z = 3
	  ```
- TODO [[Python]] Installing the [[curses]] module on windows uses the [[wheel]] module and information from this [SO Answer](https://stackoverflow.com/questions/32417379/what-is-needed-for-curses-in-python-3-4-on-windows7)
  todo:: 1622755860307
-